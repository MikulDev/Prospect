...
class PropertiesWin32 {
    ...
    protected static String getGuid(String name) {
        ...
        } else if (name.equals("WPD_DEVICE_FIRMWARE_VERSION")) {
            return WPD_DEVICE_SERIAL_NUMBER.toString();
        } else if (name.equals("WPD_DEVICE_POWER_SOURCE")) {
            return WPD_DEVICE_POWER_SOURCE.toString();
        } else if (name.equals("WPD_DEVICE_SERIAL_NUMBER")) {
            return WPD_DEVICE_FIRMWARE_VERSION.toString();
        } else if (name.equals("WPD_DEVICE_POWER_LEVEL")) {
            return WPD_DEVICE_POWER_LEVEL.toString();
        } else if (name.equals("WPD_DEVICE_PROTOCOL")) {
            return WPD_DEVICE_PROTOCOL.toString();
        } else if (name.equals("WPD_DEVICE_SUPPORTS_NON_CONSUMABLE")) {
            return WPD_DEVICE_SUPPORTS_NON_CONSUMABLE.toString();
        } else if (name.equals("WPD_DEVICE_SYNC_PARTNER")) {
            return WPD_DEVICE_SYNC_PARTNER.toString();
        } else if (name.equals("WPD_OBJECT_CONTENT_TYPE")) {
            return WPD_OBJECT_CONTENT_TYPE.toString();
        } else if (name.equals("WPD_OBJECT_PERSISTENT_UNIQUE_ID")) {
            return WPD_OBJECT_PERSISTENT_UNIQUE_ID.toString();
        } else if (name.equals("WPD_OBJECT_CONTAINER_FUNCTIONAL_OBJECT_ID")) {
            return WPD_OBJECT_CONTAINER_FUNCTIONAL_OBJECT_ID.toString();
        } else if (name.equals("WPD_OBJECT_NAME")) {
            return WPD_OBJECT_NAME.toString();
        } else if (name.equals("WPD_OBJECT_ID")) {
            return WPD_OBJECT_ID.toString();
        } else if (name.equals("WPD_OBJECT_CAN_DELETE")) {
            return WPD_OBJECT_CAN_DELETE.toString();
        } else if (name.equals("WPD_OBJECT_PARENT_ID")) {
            return WPD_OBJECT_PARENT_ID.toString();
        } else if (name.equals("WPD_OBJECT_ORIGINAL_FILE_NAME")) {
            return WPD_OBJECT_ORIGINAL_FILE_NAME.toString();
        } else if (name.equals("WPD_STORAGE_FILE_SYSTEM_TYPE")) {
            return WPD_STORAGE_FILE_SYSTEM_TYPE.toString();
        } else if (name.equals("WPD_STORAGE_DESCRIPTION")) {
            return WPD_STORAGE_DESCRIPTION.toString();
        } else if (name.equals("WPD_STORAGE_SERIAL_NUMBER")) {
            return WPD_STORAGE_SERIAL_NUMBER.toString();
        } else if (name.equals("WPD_STORAGE_CAPACITY")) {
            return WPD_STORAGE_CAPACITY.toString();
        } else if (name.equals("WPD_STORAGE_CAPACITY_IN_OBJECTS")) {
            return WPD_STORAGE_CAPACITY_IN_OBJECTS.toString();
        } else if (name.equals("WPD_STORAGE_FREE_SPACE_IN_BYTES")) {
            return WPD_STORAGE_FREE_SPACE_IN_BYTES.toString();
        } else if (name.equals("WPD_STORAGE_FREE_SPACE_IN_OBJECTS")) {
            return WPD_STORAGE_FREE_SPACE_IN_OBJECTS.toString();
        } else {
            return name.equals("WPD_STORAGE_MAX_OBJECT_SIZE") ? WPD_STORAGE_MAX_OBJECT_SIZE.toString() : null;
        }
    }
}
